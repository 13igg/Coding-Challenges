...
int main()
{
	//create 10000 bytes of heap space
	...
	cout<<"Allocating 1000 ints (size required "<<(sizeof(int) * 1000)<<" bytes)"<<endl;
	...
	//show memory
	m.dump();
	cout<<"Allocating 100 doubles (size required "<<(sizeof(double) * 100)<<" bytes)"<<endl;
	...
	cout<<"Allocating 10 Point structs(size required "<<(sizeof(Point) * 10)<<" bytes)"<<endl;
	...
	cout<<"Allocating 1000 more ints(size required "<<(sizeof(int) * 1000)<<" bytes)"<<endl;
	...
	cout<<"Allocating 1000 more ints (size required "<<(sizeof(int) * 1000)<<" bytes- shouldn't work!)"<<endl;
	//shouldn't work
	...
	cout<<"Allocating 1000 more ints (should work this time)"<<endl;
	//should work
