...
int main()
{
	...
	cout << "5x5 Magic Squares having top row 1,2,13,24,25\n";
...
//////////////////////
	count = 0;
	cout << "5x5 Magic Squares having top row 1,2,13,24,25 in any order\n";
...
int do_col1()
{
	if(a[0] + a[19] + a[21] + a[23] + a[11] == 65)
	{
		//if(rand()%100 == 0)
			//print();
		return 1;
	}
	if(a[0] + a[19] + a[21] + a[24] + a[11] == 65)
		return 1;
	return 0;
}
